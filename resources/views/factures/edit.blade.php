          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <section class="container">
                ...
                <form action="{{url('factures/'.$factures->id)}}" class="form1" method="post">
                    @method("PUT")
                    {!! csrf_field()!!}
                  ...
                  <div class="row g-2">
                    ...
                    <div class="col mb-0">
                      <label for="TypeBilans" class="form-label">Montant Total </label>
                      <input
                         type="text"
                         id="dureebilans"
                         class="form-control"
                        name="dureebilan"
                        value="{{$factures->montantT}}"
                      />
                    </div>
