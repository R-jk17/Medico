          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <section class="container">
                ...
                <form action="{{ route('visites.store') }}"class="form1" method="post">
                  ...
                  <div class="row">
                    <div class="col mb-3">
                      <label for="Datevisite" class="form-label">heure</label>
                      <input
                          type="time"
                          id="datevisite"
                          class="form-control"
                  ...
                  <div class="row">
                    <div class="col mb-3">
                      <label for="motifvisite" class="form-label">Motif</label>
                      <input
                      type="text"
                      id="visitemotif"
                      class="form-control"
                  ...
                  <div class="row">
                    <div class="col mb-3">
                      <label for="descriptionvisite" class="form-label">Description</label>
                      <input
                      type="text"
                      id="Descvisite"
                      class="form-control"
                  ...
                  <div class="column">
                    <div class="input-box">
                      ...
                      <input type="number" placeholder="1000 DA" name="montant" required />
                    </div>
                    <div class="input-box">
                      <label>versement</label>
                      <input type="number" name="versement" required />
                    </div>
                  </div>
