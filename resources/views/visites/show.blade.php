...
>
  <head>
    ...
    <title>Medico - Patient - Visites Details</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <section class="container">
                <header>Visite Details</header>
                <form  class="form1">

                  <div class="row g-2">
                    <div class="col mb-0">
                      <label for="Datevisite" class="form-label">Date</label>
                      <input
                          type="datetime-local"
                          id="datevisite"
                          class="form-control"
                          name="datevisite"
                          disabled
                          value="{{$visite->created_at}}"
                          
                      />
                    </div>
                    <div class="col mb-0">
                    <label for="visitemotif" class="form-label">Motif</label>
                    <input
                        type="text"
                        id="visitemotif"
                        class="form-control"
                  ...
                  <div class="column">
                    <div class="input-box">
                      ...
                      <input type="number" placeholder="1000 DA" name="montant" disabled value="{{$visite->montant}}"required />
                    </div>
                    <div class="input-box">
                      <label>versement</label>
                      <input type="number" name="versement" disabled value="{{$visite->versement}}"required />
                    </div>
                  </div>
                  <div class="row">
                    <div class="col mb-3">
                      ...
                      <input
                          ...
                          id="Descvisite"
                          class="form-control"
                          name="descriptionvisite"
                          disabled
                          value="{{$visite->descriptionvisite}}"
                          style="height: 20rem;"
                      />
                    </div>
                  </div>
                  ...
                  <button type="submit" ><a class="a1" href="{{url('dossiers/show")}}">Back</a></button>
                </form>
              </section>
            </div>
