...
>
  <head>
    ...
    <title>Medico - Patient - Bilans</title>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <section class="container">
                ...
                <form  class="form1">
                  ...
                  <div class="row g-2">
                    <div class="col mb-0">
                    <label for="NomBilans" class="form-label">Nom</label>
                    <input
                        type="text"
                        id="nombilan"
                        name="nombilan"
                        class="form-control"
                        disabled
                          value="{{$bilans->nombilan}}"
                    />
                    </div>
                    <div class="col mb-0">
                      <label for="TypeBilans" class="form-label">Type</label>
                      <input
                         type="text"
                         id="typebilan"
                         class="form-control"
                        name="typebilan"
                        disabled
                          value="{{$bilans->typebilan}}"
                      />
                    </div>
                    <div class="col mb-0">
                      <label for="TypeBilans" class="form-label">Durée</label>
                      <input
                         type="text"
                         id="dureebilans"
                         class="form-control"
                  ...
                  <div class="row">
                    <div class="col mb-3">
                      <label for="TypeBilans" class="form-label">Description</label>
                      <input
                         type="text"
                         id="descriptionbilan"
                         class="form-control"
                        name="descriptionbilan"
                        disabled
                          value="{{$bilans->descriptionbilan}}"
                          style="height: 20rem;"
                      />
                    </div>
                  </div>
                  ...
                  <button type="submit" ><a class="a1" href="{{url('bilans/')}}">Back</a></button>
                </form>
              </section>
            </div>
