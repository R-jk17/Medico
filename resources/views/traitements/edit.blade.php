...
>
  <head>
    ...
    <title>Medico - Patient - Traitement</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <section class="container">
                <header>Traitement en cours</header>
                <form action="{{url('traitements/'.$traitements->id)}}" class="form1" method="post">
                  @method("PUT")
                  {!! csrf_field()!!}

                  <div class="row">
                    <div class="col mb-3">
                      <label for="datetraitement" class="form-label">Date début</label>
                      <input
                          type="date"
                          id="datetraitement"
                          class="form-control"
                          placeholder="Enter Name"
                          name="debuttraitement"
                          value="{{$traitements->debuttraitement}}"
                      />
                    </div>
                  </div>
                  <div class="row g-2">
                    <div class="col mb-0">
                    <label for="NomMedicament" class="form-label">Medicament</label>
                    <input
                        type="text"
                        id="NomMedicament"
                        class="form-control"
                        name="nommedicament"
                        value="{{$traitements->nommedicament}}"
                    />
                    </div>
                    <div class="col mb-0">
                      <label for="doseMedicament" class="form-label">Dose</label>
                      <input
                         type="text"
                         id="doseMedicament"
                         class="form-control"
                         name="dosemedicament"
                         value="{{$traitements->dosemedicament}}"
                      />
                    </div>
                    <div class="col mb-0">
                      <label for="dureeMedicament" class="form-label">Durée</label>
                      <input
                         type="text"
                         id="dureeMedicament"
                         class="form-control"
                         name="dureemedicament"
                         value="{{$traitements->dureemedicament}}"
                      />
                    </div>
