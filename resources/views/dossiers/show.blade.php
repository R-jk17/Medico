...
>
  <head>
    ...
    <title>Medico - patient - fiches </title>
                ...
                <div class="col-md-12">
                      ...
                      <form class="form1">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="prenompatient" id="prenompatient" disabled value="{{$dossiers->prenompatient}}" />
                          </div>
                          <div class="mb-3 col-md-6">
                          ...
                          <div class="gender-box">
                            ...
                            <div class="gender-option">
                              <div class="gender">
                                <input type="radio" id="check-male" name="gender" checked disabled
                                value="{{$dossiers->gender}}"/>
                                <label for="check-male">male</label>
                              </div>
                              <div class="gender">
                                <input type="radio" id="check-female" name="gender" disabled
                                value="{{$dossiers->gender}}"/>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select id="situation" class="select2 form-select" name="situation" disabled value="{{$dossiers->situation}}">
                              
                              <option value="A+">Marié/e</option>
                              <option value="A-">Célibataire</option>
                              <option value="B+">Divorcé/e</option>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            disabled value="{{$dossiers->addressp}}"/>
                          </div>
                          
                          <div class="mb-3 col-md-6">
                            <label for="taille" class="form-label">taille</label>
                            <input type="number" class="form-control" id="taille" name="taille" disabled value="{{$dossiers->taille}}" />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="poids" class="form-label">Poids</label>
                            <input class="form-control" type="number" id="poids" name="poids" disabled value="{{$dossiers->poids}}"/>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="groupesang" class="form-label">groupe sanguin</label>
                            <select id="groupesang" class="select2 form-select" name="groupesang" disabled value="{{$dossiers->groupesang}}">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            disabled value="{{$dossiers->datedebuttraitement}}" />  
                          </div>
                          

                        </div>
                        <button ><a class="a1" href="{{url('dossiers/')}}">Back</a></button>
                  ...
                  <div class="card-body">
                    <div class="row">
                          ...
                          <!-- Responsive Table -->
                          <div class="card">
                            <h5 class="card-header">Visites Details</h5>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 mb-4 mb-xl-0">
                        ...
                        <div class="demo-inline-spacing mt-3">
                          <!-- Responsive Table -->
                          <div class="card">
                            <h5 class="card-header"><b>Ordonnance</b></h5>
                            <div class="table-responsive text-nowrap">
                              <table class="table">
                              <thead>
                                <tr class="text-nowrap">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{url('ordonnances/'. $item->id )}}"
                                          ><i class="bx bx-edit-alt me-1"></i> view</a
                                        >
                                        <a class="dropdown-item" href="{{url('ordonnances/'. $item->id.'/edit' )}}"
                                          ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                        >
                          ...
                          <div class="col-lg-4 col-md-6">
                            ...
                            ><a class="a1" href="{{ route('ordonnances.create', ['dossier_id' => $dossiers->id]) }}"
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="demo-inline-spacing mt-3">
                          <!-- Responsive Table -->
                          <div class="card">
                            <h5 class="card-header"><b>Bilans:</b>Bio/Radio/Kiné</h5>
                            <div class="table-responsive text-nowrap">
                              <table class="table">
                              <thead>
                                <tr class="text-nowrap">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{url('bilans/'. $item->id )}}"
                                          ><i class="bx bx-edit-alt me-1"></i> view</a
                                        >
                                        <a class="dropdown-item" href="{{url('bilans/'. $item->id.'/edit' )}}"
                                          ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                        >
                          ...
                          <div class="col-lg-4 col-md-6">
                            ...
                            ><a class="a1" href="{{ route('bilans.create', ['dossier_id' => $dossiers->id]) }}"
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <div class="demo-inline-spacing mt-3">
                            <!-- Responsive Table -->
                            <div class="card">
                              <h5 class="card-header"><b>Traitement en cours</b></h5>
                              <div class="table-responsive text-nowrap">
                                <table class="table">
                                <thead>
                                  <tr class="text-nowrap">
                                ...
                                <tbody>
                                  @foreach($traitement as $item)
                          <tr>
                            <td>{{$item->nommedicament ?? 'not exist'}}</td>
                            <td>{{$item->debuttraitement ?? 'not exist '}}</td>
                            <td>{{$item->dureemedicament ?? 'not exist '}}</td>
                            <td>
                              <div class="dropdown">
                                <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                  <i class="bx bx-dots-vertical-rounded"></i>
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="{{url('traitements/'. $item->id )}}"
                                    ><i class="bx bx-edit-alt me-1"></i> view</a
                                  >
                                  <a class="dropdown-item" href="{{url('traitements/'. $item->id.'/edit' )}}"
                                    ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                  >
                          ...
                          @endforeach
                            ...
                            <div class="col-lg-4 col-md-6">
                              ...
                              ><a class="a1" href="{{ route('traitements.create', ['dossier_id' => $dossiers->id]) }}"
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="dropdown">
                                        ...
                                        <a class="dropdown-item" href="javascript:void(0);"
                                          ><i class="bx bx-trash me-1">Supprimer</i></a
                                        >
                                        </div>
                                      </div>
                                    </td>
