              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form id="fichemedical" action="{{url('dossiers/'.$dossiers->id)}}" class="form1" method="post">
                        @method("PUT")
                        {!! csrf_field()!!}
                        <div class="row">
                          ...
                          <div class="gender-box">
                            ...
                            <div class="gender-option">
                              <div class="gender">
                                <input type="radio" id="check-male" name="gender" checked value="{{$dossiers->gender}}"/>
                                <label for="check-male">male</label>
                              </div>
                              <div class="gender">
                                <input type="radio" id="check-female" name="gender" value="{{$dossiers->gender}}" />
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select id="situation" class="select2 form-select" name="situation" value="{{$dossiers->situation}}">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control" id="taille" name="taille" value="{{$dossiers->taille}}" />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="poids" class="form-label">Poids</label>
                            <input class="form-control" type="number" id="poids" name="poids" value="{{$dossiers->poids}}"/>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="groupesang" class="form-label">groupe sanguin</label>
                            <select id="groupesang" class="select2 form-select" name="groupesang" value="{{$dossiers->groupesang}}">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            value="{{$dossiers->datedebuttraitement}}"/>  
                          </div>
